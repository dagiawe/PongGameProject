...
abstract class Paddle extends BoxWithCollision {
    ...
    abstract void MoveAI(ArrayList<MultiballWithCollision> multiballs, Paddle paddle);
}
...
class playerPaddle extends Paddle {
    ...
    //this is a method that must be here (it do nothing )
    @Override
    public void MoveAI(ArrayList<MultiballWithCollision> multiballs, Paddle paddle) {
